...
export class ReportsController {
  ...
  async getDashboardAnalytics() {
    ...
    return {
      ...
      recentActivity: [
        { type: 'export', description: 'Bangkok logistics leads exported', timestamp: '2024-12-08T14:30:00Z' },
        { type: 'import', description: 'Manufacturing prospects imported', timestamp: '2024-12-08T13:15:00Z' },
        { type: 'list', description: 'New company list created', timestamp: '2024-12-08T12:45:00Z' }
      ]
    };
  }
  ...
  @ApiResponse({ status: 200, description: 'User activity reports retrieved successfully' })
  ...
  @ApiResponse({ status: 200, description: 'Export history reports retrieved successfully' })
